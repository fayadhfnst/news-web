...
$email=$_POST['emailid'];
$query=mysqli_query($con,"Update  tbladmin set AdminUserName='$email', AdminEmailId='$email', AdminEmailId='$email'  where userType=0 && id='$aid'");
if($query)
{
...
?>
        ...
        <div class="row">
	        ...
	        <div class="col-md-10">
	        <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminUserName']);?>" name="adminusernmae" required>
	        </div>
	        </div>
            ...
            <div class="col-md-10">
            <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminPassword']);?>" name="emailid" required>
            </div>
            </div>
